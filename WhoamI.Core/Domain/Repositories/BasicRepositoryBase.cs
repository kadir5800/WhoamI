...
namespace  WhoamI.Core.Domain.Repositories
{
        ...
        where TEntity : class, IEntity
    {
        ...
        public abstract void InsertBulk(List<TEntity> entities, bool autoSave = false);

        public virtual Task InsertBulkAsync(List<TEntity> entities, bool autoSave = false, CancellationToken cancellationToken = default)
        {
            return Task.Run(() => { InsertBulk(entities, autoSave); });
        }
